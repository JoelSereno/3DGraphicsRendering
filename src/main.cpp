...
int main(void)
{
...

    {
        ...
        lvk::Holder<lvk::ShaderModuleHandle> vertSkybox = loadShaderModule(ctx, "src/skybox.vert");
        lvk::Holder<lvk::ShaderModuleHandle> fragSkybox = loadShaderModule(ctx, "src/skybox.frag");
